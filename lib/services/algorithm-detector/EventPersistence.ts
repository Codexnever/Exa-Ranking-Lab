    ...
    return result.documents.flatMap(document => {
      try {
        const legacyMetrics: DetectionMetrics = {
          ...
          affectedAverageDrift: Number(document.avgDriftScore) || 0,
          currentObservedAverageDrift: Number(document.avgDriftScore) || 0,
        ...
        const thresholds = {
          ...
          minBaselineQueries: DETECTOR_DEFAULTS.MIN_BASELINE_QUERIES,
        ...
        return [{
          ...
          evidence: {
            ...
            affectedAverageDrift: parsedMetrics.avgDriftScore,
            currentObservedAverageDrift: parsedMetrics.avgDriftScore,
            ...
            historicalObservationCount: 0,
            historicalQueryCount: parsedMetrics.historicalSampleCount,
            amountAboveBaseline: parsedMetrics.avgDriftScore - parsedMetrics.historicalAvgDrift,
