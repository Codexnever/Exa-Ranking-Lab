...
export interface QueryFoundationReadiness {
  ...
  judgmentFoundationReady: boolean
  fullEvaluationFreezeReady: boolean
  checks: {
    hasQueries: boolean
    noConflicts: boolean
    ...
    judgmentCountConsistent: boolean
    conflictCountConsistent: boolean
    noOrphanJudgments: boolean
    hasAcceptedJudgments: boolean
    everyQueryHasAcceptedJudgment: boolean
  }
  pendingPhases: Array<"judgments" | "conflict_resolution" | "final_freeze">
  reasons: string[]
}
...
export interface EvaluationQueryJudgments {
  dataset: EvaluationDatasetVersion
