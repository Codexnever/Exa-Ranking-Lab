...
export function diagnoseTrace(
  ...
  const summary =
    direction === "unavailable"
      ? "Authoritative stage diagnosis is unavailable for the recorded trace."
      : direction === "degraded"
        ? "Known relevant documents lost presence or ranking prominence across recorded stages. This is descriptive evidence and does not identify a causal component."
        : direction === "improved"
