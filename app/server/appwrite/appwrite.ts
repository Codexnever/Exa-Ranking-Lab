...
export const COLLECTIONS = {
  ...
  EVALUATION_STRATEGIES: process.env.COLLECTION_EVALUATION_STRATEGIES!,
  EVALUATION_STRATEGY_EXECUTIONS: process.env.COLLECTION_EVALUATION_STRATEGY_EXECUTIONS!,
  EVALUATION_STRATEGY_EXECUTION_DOCUMENTS: process.env.COLLECTION_EVALUATION_STRATEGY_EXECUTION_DOCUMENTS!,
}
